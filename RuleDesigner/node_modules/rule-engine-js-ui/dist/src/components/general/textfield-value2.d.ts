 ...
 */
export default function TextFieldValue2({ property, bufferKey, isPropertySelect, propertyMenuItems, inputWidth, handleValueChange, }: TextFieldValue2Props): JSX.Element;
export {};
